...
const UtilsEnums_1 = __importDefault(require("./Private/UtilsEnums"));
const Desembolso_1 = __importDefault(require("./Private/Desembolso"));
const Pre_Cierre_1 = __importDefault(require("./Private/Pre-Cierre"));
const Roles_1 = __importDefault(require("./Private/Roles"));
...
router.use('/pre-cierre', Pre_Cierre_1.default);
